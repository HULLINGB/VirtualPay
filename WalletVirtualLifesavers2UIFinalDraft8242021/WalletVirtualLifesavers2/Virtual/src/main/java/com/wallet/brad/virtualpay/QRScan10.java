...
public class QRScan10 extends Activity implements ZXingScannerView.ResultHandler {

    private static final int REQUEST_CAMERA = 1;
    private ZXingScannerView scannerView;
    private static int camId = Camera.CameraInfo.CAMERA_FACING_BACK;
    public String resultMessage = "";
    DatabaseOpenHelper13 db = null;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        intentIntegrator.setCaptureActivity(QRScan10.class);
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(QRScan10.this)
                .setMessage(message)
    ...
    public void handleResult(Result result) {
        ...
        try {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    scannerView.resumeCameraPreview(QRScan10.this);
        ...
        Intent intent = new Intent(QRScan10.this, Menu.class);
