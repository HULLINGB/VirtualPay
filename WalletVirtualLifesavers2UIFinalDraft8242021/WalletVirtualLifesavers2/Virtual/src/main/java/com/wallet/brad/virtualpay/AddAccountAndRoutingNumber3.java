...
public class AddAccountAndRoutingNumber3 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseOpenHelper6 myDb;
        myDb = new DatabaseOpenHelper6(this);
        try{

            Button mEnter, mFinish, mScan, mScanBarcode, mBack;
            mBack = (Button) findViewById(R.id.backbutton);

            final Intent intent6 = new Intent(AddAccountAndRoutingNumber3.this, MainActivity.class);
            ...
            mEnter.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), AddAccountAndRoutingNumber4.class);
...
/**
            mScan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final Intent intent = new Intent(getApplicationContext(), QRScan3.class);
                    intent.setFlags(Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
                    intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                    intent.setAction(Intent.ACTION_SEND);
            ...
            mScanBarcode.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), BarcodeScan5.class);
                    intent.setFlags(Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
                    intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                    intent.setAction(Intent.ACTION_SEND);
