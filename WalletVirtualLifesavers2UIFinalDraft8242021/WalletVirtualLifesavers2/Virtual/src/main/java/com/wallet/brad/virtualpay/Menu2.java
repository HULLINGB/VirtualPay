...
public class Menu2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         **/
        final Intent intent2 = new Intent(Menu2.this, HowMuchToPay2.class);
