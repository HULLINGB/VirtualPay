...
public class PayBarcode7 extends Activity {
    ...
    private void initView() {
        ...
        try{
            imageView = findViewById(R.id.payBarcode);

            String productId = finalBarcode;
            ...
            BitMatrix byteMatrix = codeWriter.encode(productId, BarcodeFormat.CODE_128,600, 200, hintMap);
