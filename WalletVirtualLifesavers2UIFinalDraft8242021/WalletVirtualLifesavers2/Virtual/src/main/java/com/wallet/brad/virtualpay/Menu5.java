...
public class Menu5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         **/
        final Intent intent2 = new Intent(Menu5.this, HowMuchToPay5.class);
