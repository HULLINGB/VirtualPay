...
public class BarcodeScan12 extends Activity implements ZXingScannerView.ResultHandler {
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(BarcodeScan12.this)
                .setMessage(message)
    ...
    public void handleResult(Result result) {
        ...
        try {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    scannerView.resumeCameraPreview(BarcodeScan12.this);
        ...
        Intent intent = new Intent(BarcodeScan12.this, Menu.class);
