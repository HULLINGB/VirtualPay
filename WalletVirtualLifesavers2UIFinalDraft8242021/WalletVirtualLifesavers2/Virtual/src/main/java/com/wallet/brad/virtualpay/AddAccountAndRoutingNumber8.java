...
public class AddAccountAndRoutingNumber8 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            final Intent intent6 = new Intent(AddAccountAndRoutingNumber8.this, MainActivity.class);
            ...
            mEnter.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), AddAccountAndRoutingNumber9.class);
...
/**
            mScan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final Intent intent = new Intent(getApplicationContext(), QRScan8.class);
                    intent.setFlags(Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
                    intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                    intent.setAction(Intent.ACTION_SEND);
            ...
            mScanBarcode.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), BarcodeScan10.class);
                    intent.setFlags(Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
                    intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                    intent.setAction(Intent.ACTION_SEND);
