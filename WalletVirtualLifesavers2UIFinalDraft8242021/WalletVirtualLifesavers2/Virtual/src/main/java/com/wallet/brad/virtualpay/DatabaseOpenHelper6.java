 ...
 */
public class DatabaseOpenHelper6 extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "Student3.db";
    public static final String TABLE_NAME = "fake_info3";
    ...
    public DatabaseOpenHelper6(Context context) {
    ...
    public boolean insertData(String name, String surname, String marks) {
        ...
        contentValues.put(DatabaseOpenHelper6.CARD_NUMBER, name);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper6.EXPIRATION, surname);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper6.CVV, marks);
        db.insert(TABLE_NAME, null, contentValues);
        contentValues.clear();
