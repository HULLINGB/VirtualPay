...
class DatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME = "card_user";
    ...
    public boolean insertData(String name, String surname, String marks) {
        ...
        contentValues.put(DatabaseOpenHelper.CARD_NUMBER, name);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper.EXPIRATION, surname);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper.CVV, marks);
        db.insert(TABLE_NAME, null, contentValues);
        contentValues.clear();
