 ...
 */
public class DatabaseOpenHelper7 extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "Student4.db";
    public static final String TABLE_NAME = "fake_info4";
    ...
    public DatabaseOpenHelper7(Context context) {
    ...
    public boolean insertData(String name, String surname, String marks) {
        ...
        contentValues.put(DatabaseOpenHelper7.CARD_NUMBER, name);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper7.EXPIRATION, surname);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper7.CVV, marks);
        db.insert(TABLE_NAME, null, contentValues);
        contentValues.clear();
