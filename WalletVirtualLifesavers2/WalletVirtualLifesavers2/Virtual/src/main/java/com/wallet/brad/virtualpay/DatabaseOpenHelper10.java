 ...
 */
public class DatabaseOpenHelper10 extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "Student7.db";
    public static final String TABLE_NAME = "fake_info7";
    ...
    public DatabaseOpenHelper10(Context context) {
    ...
    public boolean insertData(String name, String surname, String marks) {
        ...
        contentValues.put(DatabaseOpenHelper10.CARD_NUMBER, name);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper10.EXPIRATION, surname);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper10.CVV, marks);
        db.insert(TABLE_NAME, null, contentValues);
        contentValues.clear();
