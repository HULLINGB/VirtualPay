 ...
 */
public class DatabaseOpenHelper5 extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "Student2.db";
    public static final String TABLE_NAME = "fake_info2";
    ...
    public DatabaseOpenHelper5(Context context) {
    ...
    public boolean insertData(String name, String surname, String marks) {
        ...
        contentValues.put(DatabaseOpenHelper5.CARD_NUMBER, name);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper5.EXPIRATION, surname);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper5.CVV, marks);
        db.insert(TABLE_NAME, null, contentValues);
        contentValues.clear();
