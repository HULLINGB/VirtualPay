...
public class AddAccountAndRoutingNumber2 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseOpenHelper5 myDb;
        myDb = new DatabaseOpenHelper5(this);
        try{
            ...
            final Intent intent6 = new Intent(AddAccountAndRoutingNumber2.this, MainActivity.class);
            ...
            mEnter.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), AddAccountAndRoutingNumber3.class);
...
/**
            ...
            mScan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final Intent intent = new Intent(getApplicationContext(), QRScan2.class);
                    intent.setFlags(Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
                    intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                    intent.setAction(Intent.ACTION_SEND);
            ...
            mScanBarcode.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), BarcodeScan4.class);
                    intent.setFlags(Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
                    intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                    intent.setAction(Intent.ACTION_SEND);
