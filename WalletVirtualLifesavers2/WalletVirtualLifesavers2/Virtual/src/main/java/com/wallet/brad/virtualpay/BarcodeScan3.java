...
public class BarcodeScan3 extends Activity implements ZXingScannerView.ResultHandler {
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new android.support.v7.app.AlertDialog.Builder(BarcodeScan3.this)
                .setMessage(message)
    ...
    public void handleResult(Result result) {
        ...
        try {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    scannerView.resumeCameraPreview(BarcodeScan3.this);
        ...
        Intent intent = new Intent(BarcodeScan3.this, AddAccountAndRoutingNumber2.class);
