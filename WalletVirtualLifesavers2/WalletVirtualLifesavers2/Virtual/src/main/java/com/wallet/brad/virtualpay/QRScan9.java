...
public class QRScan9 extends Activity implements ZXingScannerView.ResultHandler {

    private static final int REQUEST_CAMERA = 1;
    private ZXingScannerView scannerView;
    private static int camId = Camera.CameraInfo.CAMERA_FACING_BACK;
    public String resultMessage = "";
    DatabaseOpenHelper12 db = null;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        intentIntegrator.setCaptureActivity(QRScan9.class);
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(QRScan9.this)
                .setMessage(message)
    ...
    public void handleResult(Result result) {
        ...
        try {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    scannerView.resumeCameraPreview(QRScan9.this);
        ...
        Intent intent = new Intent(QRScan9.this, AddAccountAndRoutingNumber10.class);
