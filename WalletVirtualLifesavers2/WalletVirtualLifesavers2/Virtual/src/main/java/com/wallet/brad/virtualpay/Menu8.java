...
public class Menu8 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         **/
        final Intent intent2 = new Intent(Menu8.this, HowMuchToPay8.class);
