 ...
 */
public class DatabaseOpenHelper13 extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "Student10.db";
    public static final String TABLE_NAME = "fake_info10";
    ...
    public DatabaseOpenHelper13(Context context) {
