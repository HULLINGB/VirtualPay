...
public class AddAccountAndRoutingNumber10 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            final Intent intent6 = new Intent(AddAccountAndRoutingNumber10.this, MainActivity.class);
...
/**
            mScan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final Intent intent = new Intent(getApplicationContext(), QRScan10.class);
                    intent.setFlags(Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
                    intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                    intent.setAction(Intent.ACTION_SEND);
            ...
            mScanBarcode.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), BarcodeScan12.class);
                    intent.setFlags(Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
                    intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                    intent.setAction(Intent.ACTION_SEND);
