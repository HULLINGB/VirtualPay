...
public class Menu10 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         **/
        final Intent intent2 = new Intent(Menu10.this, HowMuchToPay10.class);
