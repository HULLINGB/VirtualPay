...
public class Menu3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         **/
        final Intent intent2 = new Intent(Menu3.this, HowMuchToPay3.class);
