...
public class BarcodeScan10 extends Activity implements ZXingScannerView.ResultHandler {
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(BarcodeScan10.this)
                .setMessage(message)
    ...
    public void handleResult(Result result) {
        ...
        try {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    scannerView.resumeCameraPreview(BarcodeScan10.this);
        ...
        Intent intent = new Intent(BarcodeScan10.this, AddAccountAndRoutingNumber9.class);
