 ...
 */
public class DatabaseOpenHelper12 extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "Student9.db";
    public static final String TABLE_NAME = "fake_info9";
    ...
    public DatabaseOpenHelper12(Context context) {
    ...
    public boolean insertData(String name, String surname, String marks) {
        ...
        contentValues.put(DatabaseOpenHelper12.CARD_NUMBER, name);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper12.EXPIRATION, surname);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper12.CVV, marks);
        db.insert(TABLE_NAME, null, contentValues);
        contentValues.clear();
