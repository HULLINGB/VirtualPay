 ...
 */
public class DatabaseOpenHelper8 extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "Student5.db";
    public static final String TABLE_NAME = "fake_info5";
    ...
    public DatabaseOpenHelper8(Context context) {
    ...
    public boolean insertData(String name, String surname, String marks) {
        ...
        contentValues.put(DatabaseOpenHelper8.CARD_NUMBER, name);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper8.EXPIRATION, surname);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper8.CVV, marks);
        db.insert(TABLE_NAME, null, contentValues);
        contentValues.clear();
