...
public class AddAccountAndRoutingNumber4 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseOpenHelper7 myDb;
        myDb = new DatabaseOpenHelper7(this);
        try{

            Button mEnter, mFinish, mScan, mScanBarcode, mBack;
            mBack = (Button) findViewById(R.id.backbutton);

            final Intent intent6 = new Intent(AddAccountAndRoutingNumber4.this, MainActivity.class);
            ...
            mEnter.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), AddAccountAndRoutingNumber5.class);
...
/**
            mScan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final Intent intent = new Intent(getApplicationContext(), QRScan4.class);
                    intent.setFlags(Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
                    intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                    intent.setAction(Intent.ACTION_SEND);
            ...
            mScanBarcode.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), BarcodeScan6.class);
                    intent.setFlags(Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
                    intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                    intent.setAction(Intent.ACTION_SEND);
