 ...
 */
public class DatabaseOpenHelper9 extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "Student6.db";
    public static final String TABLE_NAME = "fake_info6";
    ...
    public DatabaseOpenHelper9(Context context) {
    ...
    public boolean insertData(String name, String surname, String marks) {
        ...
        contentValues.put(DatabaseOpenHelper9.CARD_NUMBER, name);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper9.EXPIRATION, surname);
        db.insert(TABLE_NAME, null, contentValues);


        contentValues.put(DatabaseOpenHelper9.CVV, marks);
        db.insert(TABLE_NAME, null, contentValues);
        contentValues.clear();
